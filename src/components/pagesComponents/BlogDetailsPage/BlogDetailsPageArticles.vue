        ...
        <div class="blog-details__wrap">
            <div class="blog-details">
                <div class="article" v-for="article in filterArticle" :key="article.id">
                    ...
                    <img class="article__img" :src="require('../../../assets/images/' + article.img)"
                        :alt="article.img">
                    <div class="article__info">
                        <p class="article__info-data">26 December,2022</p>
                        <p class="article__info-link">Interior / Home / Decore</p>
                    </div>
                    <p class="article__text">Lorem ipsum dolor sit amet, adipiscing Aliquam eu sem vitae
                        turpmaximus.posuere
                        in.Contrary to popular belief.There are many variations of passages of Lorem Ipsum available,
                        but the majority
                        have suffered alteration in some form, by injecthumour, or randomised words which don't look
                        even slightly
                        believable.</p>
                    <br>
                    <p class="article__text">Embarrassing hidden in the middle of text. All the Lorem Ipsum generators
                        on the
                    ...
                    <div class="article__list">
                        <div class="article__list-num">
                            ...
                            <p class="article__list-item">Contrary to popular belief.There are many ariations of
